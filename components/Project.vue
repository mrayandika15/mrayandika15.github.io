    ...
    <div class="flex w-full h-screen">
        <div class="flex  w-full mt-24 flex-col ">
            ...
            <!-- <div class="flex text-white w-full items-center flex-col  md:ml-16 md:flex-row md:flex-wrap"> -->
                <div class="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-2 xl:grid-cols-2  place-items-center">
                <div class="card relative w-full md:w-100 md:h-full my-4 md:mr-14 cursor-pointer" v-for="card in DataContent" >
